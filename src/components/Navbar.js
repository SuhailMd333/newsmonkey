...
const Navbar = () => {
    ...
    return (
      <div>
        <nav className="navbar navbar-expand-lg  d-flex fixed-top navbar navbar-dark bg-primary">
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className=" ">
          <button type="button"  className="btn btn-warning btn-sm mx-3" >Sign Up</button>
        </li>
        <li className=" ">
